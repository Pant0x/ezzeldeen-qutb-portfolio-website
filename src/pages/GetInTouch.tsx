...
export default function GetInTouch() {
  ...
  return (
    <div className="min-h-screen pt-28 pb-24 px-4 sm:px-6 lg:px-8 cyber-grid">
      <div className="max-w-4xl mx-auto">
        <TerminalSection title="get_in_touch.py" className="neon-card">
          <div className="space-y-10">
            <div className="text-center space-y-4">
              <h1 className="text-4xl font-bold neon-text neon-pulse">Get In Touch</h1>
              <p className="text-muted-foreground font-mono text-sm max-w-2xl mx-auto">Have a project, idea, or collaboration in mind? Send me a direct message below and it will arrive in my inbox securely.</p>
            </div>
            <form onSubmit={onSubmit} className="space-y-6">
              ...
              <div className="flex items-center gap-4">
                <button disabled={status==='sending'} className="pixel-border bg-terminal-green text-background font-mono font-bold px-6 py-3 text-sm inline-flex items-center gap-2 hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-[2px_2px_0_hsl(var(--border))] active:translate-x-1 active:translate-y-1 active:shadow-none transition-all">
            ...
            <div className="text-center font-mono text-xs text-muted-foreground pt-4 border-t border-neon-purple/30">Secure email delivery powered by Resend API.</div>
          </div>
        </TerminalSection>
      </div>
    </div>
